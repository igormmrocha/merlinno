...
const Navigation = () => {
  ...
  return (
    <nav className="bg-mod shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          <div className="flex items-center">
            <div className="flex-shrink-0" onClick={handleClick} style={{ cursor: 'pointer' }}>
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              <button className ='bg-white rounded-md p-2 text-black'  onClick={() => window.location.href ='#footer'}>Entre em contato</button>
